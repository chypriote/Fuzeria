                        ...
                        <div class="topbar">
                            <div class="container">
                                ...
                                <div class="topbar-social">
                                    <a href="http://twitter.com/undergroundmc" class="topbar-social-link" target="_blank"><i class="fa fa-twitter"></i>&nbsp;Twitter</a>
                                    &nbsp;&nbsp;
                                    <a href="https://www.facebook.com/Undergroundserv" class="topbar-social-link" target="_blank"><i class="fa fa-facebook-square"></i>&nbsp;Facebook</a>
                                </div>
            ...
            <div class="copyright">
                <div class="container">
                    <p class="text-center">
                        ...
                        */
                        ?>
                        Ce site n'est en aucun cas affilié avec Mojang AB. Propulsé par<a href="http://extaz-cms.com/" target="_blank">ExtazCMS <?php echo $version; ?></a>pour UndergroundMC
                    </p>
                </div> 
            </div><!--/copyright--> 
        </div>   
